...
public class CentroDistribucionTest {
    ...
    public void testPrioridadUrgente() {
        ...
        Paquete<String> normal = new Paquete<>("1", 10, "A", "Centro", "x", false);
        Paquete<String> urgente = new Paquete<>("2", 10, "A", "Centro", "x", true);
    ...
    public void testPrioridadPorPeso() {
        ...
        Paquete<String> normal = new Paquete<>("1", 10, "A", "Centro", "x", false);
        Paquete<String> pesado = new Paquete<>("2", 60, "A", "Centro", "x", false);
    ...
    public void testOrdenNormal() {
        ...
        Paquete<String> p1 = new Paquete<>("1", 10, "A", "Centro", "x", false);
        Paquete<String> p2 = new Paquete<>("2", 10, "A", "Centro", "x", false);
